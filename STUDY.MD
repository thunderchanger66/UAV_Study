...
第一次测试系数生成轨迹结果：
<p align="center">
   <img src="./Picture/xyztest.png"><br>
   <b>图：xyztest示意图</b>
</p>

现在进行采样后，获得了实际给到无人机的坐标：
<p align="center">
   <img src="./Picture/sample1.png"><br>
   <b>图：连线轨迹示意图</b>
</p>
<p align="center">
   <img src="./Picture/sample2.png"><br>
   <b>图：离散轨迹示意图</b>
</p>

- 关于每段时间的优化：
采用最大加速-最大匀速-最大减速的时间段寻找方式，优化时间
这样就会出现没有匀速阶段的情况，分为梯形位移图以及三角形位移图，计算好时间即可

---

# 3.3 代码问题
- ROS与PX4的坐标系问题，ROS是FLU，PX4是FRD，这两个坐标之前，Y和Z的符号虚相反
- 使用ROS的参数输入，不能使用std::vector<Eigen::Vector3d>，要用std::vector<double>每三个一组读取
- PX4的话题信息在Rviz中全部不能可视化，要显示轨迹的话需要自己将话题信息进行转换
- 现在还有个问题就是arm()后，已经开始发布坐标信息，但是无人机需要一定时间才能开始飞行

---

# 4. ADRC
ADRC = “ESO 估扰 + 线性/非线性状态反馈 + 扰动补偿”
ADRC一般处理串联积分器形式系统，这里主要推导LADRC的实现：
<p align="center">
   <img src="./Picture/微信图片_20251223220427.jpg"><br>
   <b>图：LADRC推导</b>
</p>

<p align="center">
   <img src="Picture\屏幕截图 2025-12-24 234052.png"><br>
   <img src="Picture\屏幕截图 2025-12-24 234711.png"><br>
   <img src="Picture\屏幕截图 2025-12-25 212711.png"><br>
   <img src="Picture\屏幕截图 2025-12-25 221421.png"><br>
   <img src="Picture\屏幕截图 2025-12-29 170159.png"><br>
   <img src="Picture\屏幕截图 2025-12-29 185753.png"><br>
</p>
...
## 5.2 关键理解
根据f值最小取出一个节点，这是靠近终点的保证
**在这个节点周围邻居拓展，找到到这些邻居g值最小的，更新更小的g值，加入open_list，这是最短路径的保证**
接下来重复
